...
Tabla de promedios entre preferencias de meritocracia y atribuciones
...
Tabla de contingencia atribuciones de pobreza 2019 (HAY QUE MODIFICAR VARIABLES PARA QUE AMBAS SEAN CATEGORICAS)

```{r echo=FALSE, results='asis',warning=FALSE, message=FALSE}

sjt.xtab(data_naomit2019$pmerit, data_naomit2019$attclass,
        show.col.prc=TRUE,
        show.summary=FALSE
)
```
