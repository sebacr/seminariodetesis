...
cep_2009 <- read_sav("../Input/Data/2009/Encuesta_CEP_2009/Encuesta_CEP_59.sav") #Leer base sav
...
proc_cep_2009$at_riqueza1 <- sjlabelled::set_labels(proc_cep_2009$at_riqueza1,
            labels=c( "La iniciativa personal","La suerte","La fe en dios","El trabajo responsable","Los contactos o 'pitutos' (parientes, amigos)","El nivel educacional alcanzado","La situación económica de los padres","Las ayuda económica del Estado","Las políticas económicas del gobierno","Tener una familia unida que apoya","Haciendo dinero a la mala, con manejos deshonestos","Otros/No sabe/ No contesta"))

proc_cep_2009$at_riqueza2 <- sjlabelled::set_labels(proc_cep_2009$at_riqueza2,
            labels=c( "La iniciativa personal","La suerte","La fe en dios","El trabajo responsable","Los contactos o 'pitutos' (parientes, amigos)","El nivel educacional alcanzado","La situación económica de los padres","Las ayuda económica del Estado","Las políticas económicas del gobierno","Tener una familia unida que apoya","Haciendo dinero a la mala, con manejos deshonestos","Otros/No sabe/ No contesta"))
...
proc_cep_2019$at_riqueza1 <- sjlabelled::set_labels(proc_cep_2019$at_riqueza1,
            labels=c( "La iniciativa personal","La suerte","La fe en dios","El trabajo responsable","Los contactos o 'pitutos' (parientes, amigos)","El nivel educacional alcanzado","La situación económica de los padres","Las ayuda económica del Estado","Las políticas económicas del gobierno","Tener una familia unida que apoya","Haciendo dinero a la mala, con manejos deshonestos","Otros/No sabe/ No contesta"))

proc_cep_2019$at_riqueza2 <- sjlabelled::set_labels(proc_cep_2019$at_riqueza2,
            labels=c( "La iniciativa personal","La suerte","La fe en dios","El trabajo responsable","Los contactos o 'pitutos' (parientes, amigos)","El nivel educacional alcanzado","La situación económica de los padres","Las ayuda económica del Estado","Las políticas económicas del gobierno","Tener una familia unida que apoya","Haciendo dinero a la mala, con manejos deshonestos","Otros/No sabe/ No contesta"))
