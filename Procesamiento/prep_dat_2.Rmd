...
proc_data_2019 <- na.omit(proc_data_2019) 
...
proc_data_2019<-proc_data_2019 %>% mutate(attclass =
...
### Ahora se generan dos variables por separado para at. de pobreza y de riqueza

proc_data_2019<-proc_data_2019 %>% mutate(pob_attclass =
                     case_when(Att_p1 == "atribucion interna" & 
...
proc_data_2019<-proc_data_2019 %>% mutate(riq_attclass =
...
# Ahora clasificamos. Si es 4 o menos = int, si es 
...
proc_data[, Att_r2 := ifelse(at_riqueza1 %in% c("El nivel educacional alcanzado", "La iniciativa personal", "El trabajo responsable"), "atribucion interna",
               ifelse(at_riqueza1 %in% c("La fe en dios", "Las ayuda económica del Estado", "Los contactos o 'pitutos' (parientes, amigos)","La situación económica de los padres","Tener una familia unida que apoya","Haciendo dinero a la mala, con manejos deshonestos","La suerte","Las políticas económicas del gobierno"), "atribucion externa", NA))]
